...
all_histograms[120j::hist.rebin(2), "4j1b", "ttbar", "btag_var_0_down"].plot(label="NP 1", linewidth=2, ax=ax)
all_histograms[120j::hist.rebin(2), "4j1b", "ttbar", "btag_var_1_down"].plot(label="NP 2", linewidth=2, ax=ax)
all_histograms[120j::hist.rebin(2), "4j1b", "ttbar", "btag_var_2_down"].plot(label="NP 3", linewidth=2, ax=ax)
all_histograms[120j::hist.rebin(2), "4j1b", "ttbar", "btag_var_3_down"].plot(label="NP 4", linewidth=2, ax=ax)
ax.legend(frameon=False)
ax.set_xlabel("HT [GeV]")
ax.set_title("b-tagging variations");
fig.savefig('b-tagging_variations_nano_5.png')
plt.show()
...
fig.savefig('jet_energy_variations_nano_5.png')
plt.show()
